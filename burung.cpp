...
void updateScore(){
	gotoxy(WIN_WIDTH + 7, 5);cout<<"NILAI : "<<score<<endl;
}
...
void instructions(){
	...
	cout<<"Cara Bermain";
	cout<<"\n----------------";
	cout<<"\n Tekan Tombol Spasi agar Burung Terbang";
...
void play(){
	...
	gotoxy(WIN_WIDTH + 2, 14);cout<<" Spasi = Lompat";
	
	gotoxy(10, 5);cout<<"Tekan Tombol Apa Saja";
	getch();
	gotoxy(10, 5);cout<<"                      ";
...
//	play();
	...
	do{
		...
		gotoxy(10,10); cout<<"2. Cara Bermain";	 
